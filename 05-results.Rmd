...
ggplot(compare_trip_data) +
  ...
  ggtitle("Number of trips before and after pandamic", sub = "sorted by before pandemic") + ylab("State") + xlab("Averaged daily trip number(in thousand)")+ 
  theme_dotplot+ 
...
ggplot(state_agg, aes(y = Freq/1000000, axis1 = state, axis2 = `Trips in Different Distance`))+
  ...
  labs(y="Frequency") + 
  ggtitle("How far does people travel during pandemic (in millions)") + theme_grey(22)
