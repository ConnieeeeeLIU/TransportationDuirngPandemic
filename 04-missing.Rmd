...
As described in section 2, this data set is about the number of trips by distance. First, we show the missing data visualizations.  According to the label, the black area indicates the missing value in the data set. 
...
```{r t2, fig.height = 4, fig.width = 11}
